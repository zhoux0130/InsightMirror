      ...
      <section className="detail-shell">
        <div className="login-page">
          <div className="login-card card">
            <h2 className="login-title">{mode === 'login' ? '登录 ecp-vision' : '注册 ecp-vision'}</h2>
            <p className="login-subtitle">{mode === 'login' ? '登录以使用完整功能' : '创建账号以使用完整功能'}</p>
            ...
            <button className="btn btn-ghost login-back-btn" type="button" onClick={() => navigate('/')}>
              返回首页
            </button>
          </div>
        </div>
